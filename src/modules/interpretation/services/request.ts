...
const instructions = Object.freeze([
  ...
  'Treat explicit proper names in the Entry as identified new Concepts unless the wording itself makes their identity ambiguous; missing background details alone do not make a named Concept uncertain.',
  ...
  'Represent durable facts and relationships as Axioms; do not hide them only inside Concept definitions.',
  'Represent an explicit date or date-time that qualifies a durable fact as its own Axiom instead of preserving it only in a Concept definition.',

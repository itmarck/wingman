...
import type { SuggestionDetector, SuggestionSignal } from './domain/detector.js';

/** Immutable detector catalog with dependency-driven selection. */
export class DetectorRegistry {
  readonly #detectors = new Map<string, SuggestionDetector>();
  ...
  register(detector: SuggestionDetector): void {
  ...
  relevant(signal: SuggestionSignal): readonly SuggestionDetector[] {
  ...
  list(): readonly SuggestionDetector[] {

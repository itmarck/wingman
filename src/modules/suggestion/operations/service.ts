...
import type { GrantIntentConsentCommand } from '../../execution/operations/control.js';
...
export class SuggestionService {
  ...
  async evaluate(signal: SuggestionSignal): Promise<readonly Suggestion[]> {
    await this.expire();
...
function triggerFor(signal: SuggestionSignal) {

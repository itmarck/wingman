...
- [x] 1.3 Cover valid drafts, unsupported effects, placeholders, temporal precision, and malformed output in contract tests
...
- [x] 3.1 Add exact-text deterministic interpretation fixtures and observable expectations for every UTF-8 Entry in `docs/entries.md`
...
- [x] 4.1 Add behavior tests for captured tasks, habits, reminder deadlines, unresolved placeholders, unsupported event sources, quotations, ideas, and destructive requests
